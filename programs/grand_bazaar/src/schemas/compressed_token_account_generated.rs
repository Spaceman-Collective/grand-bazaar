...
impl<'a> CompressedTokenAccount<'a> {
    ...
    pub fn create<'bldr: 'args, 'args: 'mut_bldr, 'mut_bldr>(
        ...
        if let Some(x) = args.collection_id {
            builder.add_collection_id(x);
        }
        builder.finish()
    }
        ...
        unsafe {
            self._tab
                .get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, u8>>>(
                    CompressedTokenAccount::VT_COLLECTION_ID,
                    None,
                )
        }
    }
    ...
    pub fn amount(&self) -> u64 {
        ...
        unsafe {
            self._tab
                .get::<u64>(CompressedTokenAccount::VT_AMOUNT, Some(0))
                .unwrap()
        }
    }
}
...
impl<'a: 'b, 'b> CompressedTokenAccountBuilder<'a, 'b> {
    #[inline]
    pub fn add_collection_id(
        &mut self,
        collection_id: flatbuffers::WIPOffset<flatbuffers::Vector<'b, u8>>,
    ) {
    ...
    pub fn add_amount(&mut self, amount: u64) {
        self.fbb_
            .push_slot::<u64>(CompressedTokenAccount::VT_AMOUNT, amount, 0);
    }
    #[inline]
    pub fn new(
        _fbb: &'b mut flatbuffers::FlatBufferBuilder<'a>,
    ) -> CompressedTokenAccountBuilder<'a, 'b> {
...
pub fn root_as_compressed_token_account(
    buf: &[u8],
) -> Result<CompressedTokenAccount, flatbuffers::InvalidFlatbuffer> {
...
pub fn size_prefixed_root_as_compressed_token_account(
    buf: &[u8],
) -> Result<CompressedTokenAccount, flatbuffers::InvalidFlatbuffer> {
...
pub unsafe fn size_prefixed_root_as_compressed_token_account_unchecked(
    buf: &[u8],
...
#[inline]
pub fn finish_size_prefixed_compressed_token_account_buffer<'a, 'b>(
    fbb: &'b mut flatbuffers::FlatBufferBuilder<'a>,
    root: flatbuffers::WIPOffset<CompressedTokenAccount<'a>>,
) {
